...
<div class="page-header">
    <div>
        ...
        <p>Selamat datang, <?= esc($guru['nama']) ?></p>
    </div>
</div>
...
<div class="row g-2 mb-3">
    <div class="col-6 col-lg-4">
        <div class="stat-card">
            ...
            <div class="stat-body">
                <div class="stat-value" style="font-size:1rem"><?= esc($guru['nama']) ?></div>
                <div class="stat-label">NUPTK: <?= esc($guru['nuptk']) ?></div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-4">
        <div class="stat-card">
            <div class="stat-icon" style="background:rgba(16,185,129,0.12);color:#10b981"><i class="bi bi-building"></i></div>
            <div class="stat-body">
                <div class="stat-value" style="font-size:1rem"><?= $waliKelas ? esc($waliKelas['nama_kelas']) : '-' ?></div>
...
<div class="card-custom">
    <div class="card-header"><i class="bi bi-calendar-day me-1"></i>Jadwal Hari Ini — <?= strftime('%A') ?? date('l') ?>, <?= date('d/m/Y') ?></div>
            ...
            <table class="table table-custom table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Kelas"><?= esc($j['nama_kelas'] ?? $j['nama_rombel'] ?? '-') ?></td>
                    </tr>
                    <?php endforeach; ?>
